...
Apply the **principle-type-system-discipline** principle skill first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Validate where data crosses in; trust types inside. See the **principle-boundary-discipline** principle skill. |
