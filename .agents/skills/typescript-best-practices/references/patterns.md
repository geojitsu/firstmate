...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see the **principle-type-system-discipline** and **principle-boundary-discipline** principle skills.
