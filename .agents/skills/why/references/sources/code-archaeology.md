...
- PR descriptions, review comments, and discussion threads (via `gh-axi`)
...
gh-axi pr view <number> --json title,body,author,createdAt,mergedAt,labels,closingIssuesReferences,comments,reviews,files
