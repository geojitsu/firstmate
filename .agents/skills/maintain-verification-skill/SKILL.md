...
Ship proven verification-skill corrections only through Firstmate's configured delivery path. Never merge or create an independent review control plane.
